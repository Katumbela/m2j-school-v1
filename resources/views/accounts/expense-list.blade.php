    ...
    <div class="row">
        ...
        <div class="col-md-10" id="main-container">
            <div class="panel panel-default">
                <div class="page-panel-title">Ver Lista de Despesas
                <button class="btn btn-xs btn-success pull-right" role="button" id="btnPrint" ><i class="material-icons">print</i> Imprimir Esta Lista de Despesas</button></div>
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="{{url('/accounts/list-expense')}}" method="post">
                      ...
                      <div class="form-group">
                        <div class="col-sm-offset-4 col-sm-8">
                          <button type="submit" class="btn btn-danger">Obter Lista de Despesas</button>
                        </div>
                      </div>
                    </form>
                    @isset($expenses)
                    <div class="table-responsive">
                      <table class="table table-data-div table-hover">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><a title='Editar' class='btn btn-info btn-sm' href='{{url("accounts/edit-expense")}}/{{$expense->id}}'>Editar</a></td>
                          </tr>
                          @endforeach
                        </tbody>
                      </table>
                      ...
                      <h4 style="text-align:center;">Lista de Despesas</h4>
...
$("#btnPrint").on("click", function () {
            ...
            printWindow.document.write('<html><head><title>Lista de Despesas</title>');
