        ...
        <div class="col-md-{{ (\Auth::user()->role == 'master')? 12 : 8 }}" id="main-container">
            ...
            <div class="page-panel-title">Register {{ucfirst(session('register_role'))}}</div>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ url('register/'.session('register_role')) }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('group') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="group" type="text" class="form-control" name="group" value="{{ old('group') }}" placeholder="Science, Arts, Commerce,etc.">
                        ...
                        <div class="form-group{{ $errors->has('father_phone_number') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="father_phone_number" type="text" class="form-control" name="father_phone_number" value="{{ old('father_phone_number') }}">
                        ...
                        <div class="form-group{{ $errors->has('father_national_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="father_national_id" type="text" class="form-control" name="father_national_id" value="{{ old('father_national_id') }}">
                        ...
                        <div class="form-group{{ $errors->has('father_occupation') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="father_occupation" type="text" class="form-control" name="father_occupation" value="{{ old('father_occupation') }}">
                        ...
                        <div class="form-group{{ $errors->has('father_designation') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="father_designation" type="text" class="form-control" name="father_designation" value="{{ old('father_designation') }}">
                        ...
                        <div class="form-group{{ $errors->has('father_annual_income') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="father_annual_income" type="text" class="form-control" name="father_annual_income" value="{{ old('father_annual_income') }}">
                        ...
                        <div class="form-group{{ $errors->has('mother_phone_number') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="mother_phone_number" type="text" class="form-control" name="mother_phone_number" value="{{ old('mother_phone_number') }}">
                        ...
                        <div class="form-group{{ $errors->has('mother_national_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="mother_national_id" type="text" class="form-control" name="mother_national_id" value="{{ old('mother_national_id') }}">
                        ...
                        <div class="form-group{{ $errors->has('mother_occupation') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="mother_occupation" type="text" class="form-control" name="mother_occupation" value="{{ old('mother_occupation') }}">
                        ...
                        <div class="form-group{{ $errors->has('mother_designation') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="mother_designation" type="text" class="form-control" name="mother_designation" value="{{ old('mother_designation') }}">
                        ...
                        <div class="form-group{{ $errors->has('mother_annual_income') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="mother_annual_income" type="text" class="form-control" name="mother_annual_income" value="{{ old('mother_annual_income') }}">
                        ...
                        <div class="form-group{{ $errors->has('psc_group') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="psc_group" type="text" class="form-control" name="psc_group" value="{{ old('psc_group') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('psc_roll') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="psc_roll" type="text" class="form-control" name="psc_roll" value="{{ old('psc_roll') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('psc_registration') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="psc_registration" type="text" class="form-control" name="psc_registration" value="{{ old('psc_registration') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('psc_session') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="psc_session" type="text" class="form-control" name="psc_session" value="{{ old('psc_session') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('psc_board') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="psc_board" type="text" class="form-control" name="psc_board" value="{{ old('psc_board') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('psc_passing_year') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="psc_passing_year" type="text" class="form-control" name="psc_passing_year" value="{{ old('psc_passing_year') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('psc_institution_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="psc_institution_name" type="text" class="form-control" name="psc_institution_name" value="{{ old('psc_institution_name') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('psc_gpa') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="psc_gpa" type="text" class="form-control" name="psc_gpa" value="{{ old('psc_gpa') }}" required>
