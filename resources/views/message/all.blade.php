    ...
    <div class="row">
        ...
        <div class="col-md-8" id="main-container">
            <div class="panel panel-default">
                <div class="page-panel-title">Mensagens</div>
                            ...
                            <div class="media">
                                <div class="media-left">
                                    <div class="media-object">
                                        ...
                                        <img src="{{asset('01-progress.gif')}}" data-src="https://static.vecteezy.com/system/resources/thumbnails/000/439/863/small/Basic_Ui__28186_29.jpg" style="border-radius: 50%;" width="50px" height="50px">
                                        @else
                                        <img src="{{asset('01-progress.gif')}}" data-src="https://hoteltopic.com/wp-content/uploads/2018/02/female-user-icon-7.png" style="border-radius: 50%;" width="50px" height="50px">
                                        @endif
                                        @endif
                                    </div>
                                </div>
